...
public class TransactionControllerImpl implements TransactionController {
    ...
    @Override
    // TODO add security @PreAuthorize("hasRole('ROLE_ADMIN')") after integration with Spring Security(for example)
    public ResponseEntity<SuccessResponse> addTransactionIntoAccount(@PathVariable("accountId") String accountId,
    ...
    @Override
    // TODO add security @PreAuthorize("hasRole('ROLE_ADMIN')") after integration with Spring Security(for example)
    public ResponseEntity<Void> updateTransactionByAccountId(@PathVariable("accountId") String accountId,
                                                             @PathVariable("transactionId") String transactionId,
