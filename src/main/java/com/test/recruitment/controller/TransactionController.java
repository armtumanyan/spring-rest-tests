...
public interface TransactionController {
	 ...
	 */
	@PostMapping
	ResponseEntity<SuccessResponse> addTransactionIntoAccount(@RequestBody CreateTransaction createTransaction,
															  @PathVariable("accountId") String accountId);
	...
	ResponseEntity<Void> updateTransactionByAccountId(@RequestBody UpdateTransaction updateTransaction,
													  @PathVariable("accountId") String accountId,
													  @PathVariable("transactionId") String transactionId);
}
