...
public class TransactionServiceTest {
    ...
    private static final BigDecimal VALID_BALANCE = new BigDecimal(25);
    ...
    public void processAddTransactionIntoAccountSuccess() {
        ...
        verify(transactionRepository).addTransactionIntoAccount(any(Transaction.class));
    ...
    public void processUpdateTransactionByAccountIdSuccess() {
        ...
        Transaction transaction = buildTransaction(VALID_ACCOUNT_ID);
        ...
        when(transactionRepository.findById(VALID_TRANSACTION_ID)).thenReturn(transaction);
        ...
        verify(accountService).getAccountDetails(VALID_ACCOUNT_ID);
        verify(transactionRepository).findById(VALID_TRANSACTION_ID);
        verifyNoMoreInteractions(accountService, transactionRepository);
    }
